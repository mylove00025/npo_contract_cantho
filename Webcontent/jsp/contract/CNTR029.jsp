...
<html:html>
    ...
    <div id="navigator">
            <ul class="clearfix">
                ...
                <li>
                    <span> &gt; </span>
                    <html:link href="#">Thêm mới hợp đồng chờ ký</html:link>
                </li>
            </ul>
        </div>
    <%@ include file="/jsp/common/error_message.jsp" %>

    <html:form styleId="form" action="temporarycontractregistview" enctype="multipart/form-data" >
        <html:hidden name="temporaryContractForm" property="propertySelectedIndex" />
        <html:hidden styleId="isDetailPropertyEntry" name="temporaryContractViewHelper" property="isDetailPropertyEntry" />
        <html:hidden styleId="checkLostNumber" property="checkLostNumber" value="true"/>
        ...
        <table class="tbl-none-border">
            ...
            <tr id="contractNumber_tr">
                ...
                <td>
                    <html:text styleId="contractNumber" name="temporaryContractViewHelper" property="contractNumber" onblur="checkContractNumber()"
            ...
            <tr id="type_tr">
		        <th>Tài sản</th>
		        <td colspan="3">
		            <html:select name="temporaryContractViewHelper" property="propertyType" styleId="type"
		                onchange="javascript:changeDisplayProperty();">
		                <html:optionsCollection name="temporaryContractViewHelper" property="propertyTypeList" label="name" value="code" />
		            </html:select>
		        </td>
            </tr>
            ...
            <tr class="propertyInfo" id="propertyInfo_tr">
                ...
                <td colspan="3">
                    <html:textarea styleId="propertyInfo" name="temporaryContractViewHelper" property="propertyInfo" style="width: 400px;">
                            </html:textarea>
                </td>
            </tr>            
            ...
            <tr class="land" id="landAddress_tr">
                <th>Địa chỉ</th>
                <td colspan="3">
                    <html:text styleId="landAddress" name="temporaryContractViewHelper" property="landAddress"
            ...
            <tr class="land" id="landCertificate_tr">
                ...
                <td colspan="3">
                    <html:text styleId="landCertificate" name="temporaryContractViewHelper" property="landCertificate"
                           style="width: 400px;" maxlength="200"/>
                </td>
            </tr>
            </logic:equal>
                ...
                <td colspan="3">
                    <logic:equal name="context" property="propertyLandIssuePlace" value="1">
	                    <span id="landIssuePlace_td">
		                    <html:text styleId="landIssuePlace" name="temporaryContractViewHelper" property="landIssuePlace"
		            ...
		            <span id="landIssueDate_td">
		                ...
		                <html:text name="temporaryContractViewHelper" property="landIssueDate" style="vertical-align: middle;"
                ...
                <td colspan="3">
                    <logic:equal name="context" property="propertyLandNumber" value="1">
	                    <span id="landNumber_td">
		                    <html:text styleId="landNumber" name="temporaryContractViewHelper" property="landNumber" maxlength="20"/>
	                    </span>
                    </logic:equal>
                    ...
                    <span id="landMapNumber_td">
                        Tờ bản đồ số
                        <html:text styleId="landMapNumber" name="temporaryContractViewHelper" property="landMapNumber" style="width: 156px;" maxlength="20"/>
                    </span>
                    </logic:equal>
                </td>
            </tr>
            ...
            <tr class="land">
                ...
                <td colspan="3">
                    <span id="landArea_td">
                        <html:text styleId="landArea" name="temporaryContractViewHelper" property="landArea" style="width: 52px;" maxlength="20"/>
                    </span>
                    <logic:equal name="context" property="propertyLandPrivateArea" value="1">
	                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                    Hình thức sử dụng &nbsp;&nbsp; Riêng
	                    <span id="landPrivateArea_td">
	                        <html:text styleId="landPrivateArea" name="temporaryContractViewHelper" property="landPrivateArea"
                    ...
                    <span id="landPublicArea_td">
                        <html:text styleId="landPublicArea" name="temporaryContractViewHelper" property="landPublicArea"
                                style="width: 50px;" maxlength="20"/>
                    </span>
                    </logic:equal>
                </td>
            ...
            <tr class="land" id="landUsePurpose_tr">
                ...
                <td colspan="3">
                    <html:text styleId="landUsePurpose" name="temporaryContractViewHelper" property="landUsePurpose"
            ...
            <tr class="land" id="landUsePeriod_tr">
                ...
                <td colspan="3">
                    <html:text styleId="landUsePeriod" name="temporaryContractViewHelper" property="landUsePeriod"
                           style="width: 400px;" maxlength="100"/>
                </td>
            </tr>
            </logic:equal>
            ...
            <tr class="land" id="landUseOrigin_tr">
                ...
                <td colspan="3">
                    <html:text styleId="landUseOrigin" name="temporaryContractViewHelper" property="landUseOrigin"
                           style="width: 400px;" maxlength="200"/>
                </td>
            </tr>
            </logic:equal>
            ...
            <tr class="land" id="landAssociateProperty_tr">
                ...
                <td colspan="3">
                    <html:text styleId="landAssociateProperty" name="temporaryContractViewHelper" property="landAssociateProperty"
                           style="width: 400px;" maxlength="200"/>
                </td>
            </tr>
            </logic:equal>
            ...
            <tr class="vehicle" id="carLicenseNumber_tr">
                ...
                <td colspan="3">
                    <html:text styleId="carLicenseNumber" name="temporaryContractViewHelper" property="carLicenseNumber"
                        style="width: 400px;" maxlength="200"/>
                </td>
            </tr>
            </logic:equal>
            ...
            <tr class="vehicle" id="carRegistNumber_tr">
                ...
                <td colspan="3">
                    <html:text styleId="carRegistNumber" name="temporaryContractViewHelper" property="carRegistNumber"
                           style="width: 400px;" maxlength="200"/>
                </td>
            </tr>
            </logic:equal>
                ...
                <td colspan="3">
                     <logic:equal name="context" property="propertyCarIssuePlace" value="1">
		                 <span id="carIssuePlace_td">
		                     <html:text styleId="carIssuePlace" name="temporaryContractViewHelper" property="carIssuePlace"
		                            styleClass="input-normal" style="vertical-align: middle;" maxlength="100"/>
		                 </span>
	                 </logic:equal>
	                 ...
	                 <span id="carIssueDate_td">
	                     ...
	                     <html:text name="temporaryContractViewHelper" property="carIssueDate" style="vertical-align: middle;"
                ...
                <td colspan="3">
                     <logic:equal name="context" property="propertyCarFrameNumber" value="1">
	                     <span id="carFrameNumber_td">
	                         <html:text styleId="carFrameNumber" name="temporaryContractViewHelper" property="carFrameNumber"
                     ...
                     <span id="carMachineNumber_td">
                         <html:text name="temporaryContractViewHelper" property="carMachineNumber" style="vertical-align: middle;"
            ...
            <tr class="detailEntry" id="ownerInfo_tr">
                ...
                <td colspan="3">
                    <html:text styleId="ownerInfo" name="temporaryContractViewHelper" property="ownerInfo"
            ...
            <tr class="detailEntry" id="otherInfo_tr">
                ...
                <td colspan="3">
                    <html:text styleId="otherInfo" name="temporaryContractViewHelper" property="otherInfo" style="width: 400px;" maxlength="1000"/>
                </td>
            </tr>  
            ...
            <tr class="manyProperty">
             ...
             <tr>
                <td colspan="2" style="padding-top: 10px;">
                    <span class="sub-title">◊ Ý kiến của cán bộ nghiệp vụ</span>
                    &nbsp;&nbsp;&nbsp;
                </td>
            </tr>
            <tr>
                <th></th>
                <td colspan="3">
                    <html:textarea styleId="contractComment" name="temporaryContractViewHelper" property="contractComment"
                                        style="width: 400px;">
                    </html:textarea>
                </td>
            </tr>
        ...
        <table id="otherInformation" class="tbl-none-border">
            <tr>
                ...
                <table class="tbl-none-border">
		            ...
		            <tr id="formFile_tr">
		                ...
		                <td nowrap="nowrap" colspan="3">
                            <html:file styleId="formFile" name="temporaryContractViewHelper" property="formFile" style="width: 210px;" />
                        </td>
                    </tr>
          ...
          <div style="padding-left: 250px; padding-top: 20px;">
              <span id="update_on">
                  <html:img alt="Lưu" src="./image/btn_save.png" onclick="stylechange('update_off', 'update_on'); save();"/>
              </span>
              <span id="update_off" style="display: none;">
                  <html:link href="#">
                      <html:img alt="Lưu" src="./image/btn_save.png" onclick="save();"/>
                  </html:link>
              </span>
...
<script type="text/javascript">
    ...
    function save() {
	    ...
	    var checkLostNumber = document.getElementById("checkLostNumber").value;
	    checkLostNumber = checkLostNumber.replace(/^\s+|\s+$/g, '');
	    if (checkLostNumber == 'true') {
	    	document.temporaryContractForm.action="temporarycontractregist.do";
	        document.temporaryContractForm.submit();

		} else {
			answer1 = confirm ("Số hợp đồng đã được cấp! Bạn có muốn dùng lại số hợp đồng này không?");
		    if (answer1) {
		    	  document.temporaryContractForm.action="temporarycontractregist.do";
		          document.temporaryContractForm.submit();
		    }
    ...
    function checkContractNumber() {
      	 ...
      	 contractKindId = document.getElementById("contractKindId").value;
      	 retrieveURL9('ajaxchecklostnumber.do?kindId='+ contractKindId + '&contractNumber='+val);
      	 
      	
      }

    function downloadcontractdraft() {
        document.temporaryContractForm.action='downloadcontractdraft.do';
        document.temporaryContractForm.submit();
    }
    ...
    function retrieveURL9(url) {
        if (window.XMLHttpRequest) { // Non-IE browsers
          req = new XMLHttpRequest();
          req.onreadystatechange = processStateChange9;
          try {
            req.open("GET", url, true);
            req.setRequestHeader("If-Modified-Since", "Sat, 1 Jan 2000 00:00:00 GMT");
          } catch (e) {
    ...
    function processStateChange9() {
        if (req.readyState == 4) { // Complete
          if (req.status == 200) { // OK response
        	  ...
        	  document.getElementById("checkLostNumber").value = req.responseText;          
        	  changeValue('checkLostNumber');
          } else {
    ...
    function processStateChange2() {
        if (req.readyState == 4) { // Complete
          if (req.status == 200) { // OK response
              document.getElementById("contractNumber").value = req.responseText;
              changeValue('contractNumber');
    ...
    function changeTemplate() {
    	...
    	for (var i = 0; i < aryDesc.length; i++) {
	       ...
	       //     if (aryDesc[i][4] != '') {
	        ...
	        retrieveURL2('ajaxissuecontractnumber.do?contracttemplateid=' + value);
	            break;
	        } else {
