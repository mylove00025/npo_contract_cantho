...
<html:html>
    ...
    <div id="navigator">
            <ul class="clearfix">
                ...
                <li>
                    <span> &gt; </span>
                    <html:link href="#">Sửa đổi hợp đồng công chứng</html:link>
                </li>
            </ul>
        </div>
    <%@ include file="/jsp/common/error_message.jsp" %>

    <html:form styleId="form" action="contractupdateview" enctype="multipart/form-data" onsubmit="javascript: save();">
        ...
        <html:hidden styleId="isDetailPropertyEntry" name="contractViewHelper" property="relateObjectNumber" />
        ...
        <table class="tbl-none-border">
            ...
            <tr id="contractNumber_tr">
                ...
                <td>
                    <html:text styleId="contractNumber" name="contractViewHelper" property="contractNumber"
            ...
            <tr>
                ...
                <td colspan="3">
                    <html:textarea styleId="relationObjectA" name="contractViewHelper" property="relationObjectA"
            ...
            <tr>
                ...
                <td colspan="3">
                    <html:textarea styleId="relationObjectB" name="contractViewHelper" property="relationObjectB"
                                        styleClass="input-x-long">
                    </html:textarea>
            ...
            <tr id="objectC">
                ...
                <td colspan="3">
                    <html:textarea styleId="relationObjectC" name="contractViewHelper" property="relationObjectC"
                                        styleClass="input-x-long">
                    </html:textarea>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3">
                    <html:textarea styleId="contractSummary" name="contractViewHelper" property="contractSummary" styleClass="input-x-long">
                    </html:textarea>
                </td>
            </tr>
            ...
            <tr id="notaryPlace_tr">
                ...
                <td colspan="3">
                    ...
                    <html:text styleId="notaryPlace" name="contractViewHelper" property="notaryPlace" style="width: 252px;" maxlength="200"/>
                </td>
            </tr>
            </logic:equal>
             <tr id="mortage_flag">
             <th id="mortageCancelDate_th" >Giải chấp</th>
            	<td id="mortageCancelDate_td" colspan="3">
            	
            	<html:checkbox styleId="mortageStatus" onclick="displayMortage(); " style="vertical-align:sub;" property="mortageCancelFlag" name="contractViewHelper"></html:checkbox>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            	
         		<span style="display:none" id="mortage_cancel_date">
            	Ngày giải chấp<span class="required">*</span>  
            	<html:text styleId="mortageCancelDate" name="contractViewHelper" property="mortageCancelDate" styleClass="input-normal" maxlength="10"/>
                    <html:img styleId="popupCal-3" src="./image/calendar.png" alt="calendar" styleClass="onmouseover"
                                    style="vertical-align: middle;"/>
                    <script type="text/javascript">
                   
                          new Calendar({
                              inputField: "mortageCancelDate",
                              dateFormat: "%d/%m/%Y",
                              trigger: "popupCal-3",
                              bottomBar: false,
                              onSelect: function() {
              ...
              <tr style="display:none" id="mortage_note">
            <th></th>
            <td colspan="3">
            	<html:textarea styleId="mortageCancelNote" name="contractViewHelper" property="mortageCancelNote" 
                                        styleClass="input-x-long">
                    </html:textarea> 
                    </td>	
            </tr>
        ...
        <table id="otherInformation" class="tbl-none-border">
            <tr>
                ...
                <table class="tbl-none-border">
                    <%
                    if ("1".equals(context.getContractErrorStatus()) || "1".equals(context.getSupplementContractFunction())) {
                    %>
                    <tr>
                    ...
                    <tr>
                        <th></th>
                        <td nowrap="nowrap">
                            <html:checkbox styleId="errorStatus" name="contractViewHelper" property="errorStatus"
                                                onclick="changeErrorStatus();">
                            </html:checkbox>
                            <label style="font-weight:normal" for="errorStatus">Hợp đồng lỗi</label>
                        </td>
                    </tr>
                    <tr id="errorAgent_tr" class="errorAgent">
                        <th nowrap="nowrap">Tác nhân gây lỗi</th>
                        <td nowrap="nowrap">
                           <html:select styleId="errorAgent" name="contractViewHelper" property="errorAgent">
                               <html:option value="00">[Chọn]</html:option>
                               <html:option value="02">Công chứng viên</html:option>
                               <html:option value="03">Chuyên viên soạn thảo</html:option>
                           </html:select>
                        </td>
                    </tr>
                    <tr id="errorDescription_tr" class="errorDescription">
                        <th nowrap="nowrap">Mô tả lỗi</th>
                        <td nowrap="nowrap">
                           <html:textarea name="contractViewHelper" styleId="errorDescription" property="errorDescription" style="width: 210px;"/>
                        </td>
                    </tr>
                    </logic:equal>
...
<script type="text/javascript">
    ...
    function save() {
        document.contractForm.action="contractupdate.do";
    }

    function remove() {
        var answer = confirm ("Bạn có thực sự muốn xóa không?");
        if (answer) {
            document.contractForm.action="contractremove.do";
    ...
    function accept() {
        ...
        if (validate == "true") {
            document.contractForm.action="editpropertyupdate.do";
            document.contractForm.submit();
            return true;
            disablePopup();
        }
    ...
    function addProperty() {
        document.contractForm.action="addpropertyupdate.do";
        document.contractForm.submit();
        return true;
    }
    ...
    function changeTemplate() {
        ...
        for (var i = 0; i < aryDesc.length; i++) {
            if (aryDesc[i][1] == value) {
            	...
            	var mortageFlag = document.getElementById("mortageStatus").checked;
            	
	        	if (aryDesc[i][8] == "true" || mortageFlag) {
	           		$('#mortage_flag').show();
	           	} else {
	            	$('#mortage_flag').hide();	
	            }
    ...
    function changeErrorStatus() {
        errorStatus = document.getElementById("errorStatus").checked;
        if (errorStatus) {
            $('tr.errorAgent').show();
            $('tr.errorDescription').show();
        } else {
            $('tr.errorAgent').hide();
            $('tr.errorDescription').hide();
        }
    }
    ...
    mortageStatusElement = document.getElementById("mortageStatus");
    if (mortageStatusElement != null) {
    	changeMortageStatus();
    }
    function changeMortageStatus() {
        mortageStatus = document.getElementById("mortageStatus").checked;
        if (mortageStatus) {
        	$('#mortage_cancel_date').show();
        	$('#mortage_note').show();
        } else {
        	$('#mortage_cancel_date').hide();
        	$('#mortage_note').hide();
        }
    }
  ...
  //Script for property
    ...
    function setSearchState() {
        ...
        if (otherInfoConfig == null || otherInfoConfig == "" || otherInfoConfig == "undefined") {
            ...
            setCookie("otherInfoConfig", otherInfoConfig, otherInfoConfig);
        }
        if (otherInfoConfig == "true") {
