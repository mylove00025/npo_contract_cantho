...
<html:html>
    ...
    <div id="navigator">
	    <ul class="clearfix">
	        ...
	        <li>
	            <span> > </span>
	            <html:link href="#">Tạo mới nhóm hợp đồng</html:link>
	        </li>               
	    </ul>
    </div>
    <%@ include file="/jsp/common/error_message.jsp" %>
    <html:form action="contractkindregistview" styleId="form" onsubmit="javascript: save()">
        <span class="sub-title">◊ Tạo mới nhóm hợp đồng </span>
            ...
            <tr class="contractkindlist">
                ...
                <td>
                    <html:select name="contractKindViewHelper" property="orderContractKindId">
                      	 <html:optionsCollection name="contractKindViewHelper" property="contractKindList" value="orderNumber" label="name" />
                    </html:select>
                </td>
            </tr>
            <tr>                
...
<script type="text/javascript">
	...
	function save() {
	    document.contractKindForm.action="contractkindregist.do";
	    return true;
	}
