...
//        key = escapeForSearch(key);
    ...
    public static String replaceHightlight(String text, String key) {
        ...
        return EditString.replaceChangeLine(text).replaceAll("(?iu)" + key, "<span class=\"highlighted\">" + key + "</span>");
    }
    ...
    public static String replaceHightlight2(String text, String key) {
        ...
        return text.replaceAll("(?iu)" + key, "<span class=\"highlighted\">" + key + "</span>");
    }
}