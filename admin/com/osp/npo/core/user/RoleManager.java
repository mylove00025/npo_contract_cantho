...
public class RoleManager extends AbstractManager {
     ...
     * @throws SQLException
     */
    public int insert(RoleInfo info) throws SQLException {

        StringBuffer sqlBuffer = new StringBuffer();
        sqlBuffer.append(" INSERT INTO ");
        sqlBuffer.append("npo_role");
        sqlBuffer.append(" ( ");
     ...
     * @throws IOException
     */
    public int update(RoleInfo info) throws SQLException, IOException {
     ...
     * @throws IOException
     */
    public RoleList select(boolean forUpdate, int offset, int limit) throws SQLException, IOException {
     ...
     * @throws SQLException
     */
    private void rsSetInfo(ResultSet rs, RoleInfo info) throws SQLException {
     ...
     */
    private void makeUpdateList(RoleInfo info, ArrayList<String> sqlList, ArrayList<Object> prmList) {
