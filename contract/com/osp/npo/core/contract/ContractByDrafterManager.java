 ...
 */
public class ContractByDrafterManager extends AbstractManager {
     ...
     */
    public ContractByDrafterManager(Connection connection) {
        super(connection);
    }
     ...
     */
    public Timestamp getNotaryDateToFilter() {
