 ...
 */
public class ContractByBankManager extends AbstractManager {
    ...
    private Boolean bankIdNullFilter;
     ...
     */
    public ContractByBankManager(Connection connection) {
        super(connection);
    }
    ...
    private String getWhereFilter(ArrayList<Object> prmList) {
        ...
        if (this.bankIdNullFilter !=  null) {
            if (this.bankIdNullFilter == Boolean.TRUE) {
                appendAnd(filterBuffer);
    ...
    public void setBankIdNullFilter(Boolean bankIdNullFilter) {
        this.bankIdNullFilter = bankIdNullFilter;
    }
